...
# @retry
def generateOTP():
    print(f"Will send OTP to {REGISTERED_MOBILE_NUMBER}: ")
    data = {"secret":"U2FsdGVkX18ZxYaXrzt7MUsZO4JqRbbwcSWLt8/jvpmfvqEIOQpKXnQXVn+9h8tG6nbC4iRg2WfzWEbXggyZ7A==","mobile": REGISTERED_MOBILE_NUMBER}
...
def get_authenticated_session(mobile):
    global REGISTERED_MOBILE_NUMBER
